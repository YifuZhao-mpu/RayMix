#!/usr/bin/env python3
"""Machine cross-check for paper_ojits: every number in main.tex / strata_auto.tex /
scua_matrix.tex <-> machine-printed JSONs. Run after any edit:
    python3 code/paper_ojits_claim_check.py   (exit 0 = all PASS)"""
import hashlib
import json
import os
import sys
...
PAPER = os.path.join(HERE, "..", "paper_ojits")
