...
# SemanticKITTI 64-beam SpUNet + RayMix — cross-sensor SANITY arm. IDENTICAL recipe to kitti_spunet_base_fast.py;
# train dataset = SemanticKITTIRayMixDataset. PolarMix-naive arm = launch with
