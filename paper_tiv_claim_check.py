#!/usr/bin/env python3
"""Machine cross-check: every number in paper_tiv/main.tex <-> machine-printed JSONs.
Run after any edit: python3 code/paper_tiv_claim_check.py  (exit 0 = all PASS)."""
import json, os, re, sys

PO = os.path.join(os.path.dirname(os.path.abspath(__file__)), "outputs", "poss")
TEX = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "paper_tiv", "main.tex")
